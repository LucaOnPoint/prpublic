...
<head>
  <meta charset="utf-8">
  <title>FiveM RoleV Roleplay</title>
...
<body class="body">
  <div class="content">
    <div class="container-2 w-container">
      <div>
        <a data-w-id="fd97c34e-0ce6-5332-f83e-8075cd6b6278" style="opacity:0" href="https://servers.fivem.net/servers/detail/e3oje3" class="button w-button">VERBINDEN</a>
      </div>
    </div>
    ...
    <div class="container-3 w-container">
      <div class="w-layout-grid grid">
        <div id="w-node-b697e036-735e-08c0-bc5b-b13cca0d2141-9d8417b5">
          <h1 data-w-id="5f1a2e51-a3ab-5529-5457-621fa6de47d5" style="opacity:0" class="heading-2">Projekt RoleV Roleplay</h1>
          <div data-w-id="7d10a558-c8cd-9ea6-718c-d1ba93f2dfa5" style="opacity:0" class="text-block-2">> Willkommen auf der offiziellen RoleV Landingpage!<br>RoleV, ein Projekt welches wir gestartet haben, mit dem Ziel euch eine Welt zu bieten in der ihr euch mit viel Kreativität und einem fiktiven Charakter eure eigene Rollenspielgeschichte erleben könnt. Worauf wartest du noch?

Dieses Projekt ist ein reines Community Hobbyprojekt!
(Dieses Projekt ist **Nicht** Kommerziell sondern wird Privat finanziert! )

Bitte lies dir zu Beginn einmal alle unsere Regelwerke durch um potentielle Regelbrüche zu vermeiden.

Wenn du immer auf dem neusten Stand bleiben möchtest, folge uns auf unseren Social Media Seiten:</div>
          <a data-w-id="8cbfab13-cb16-26d0-f544-6175ac9f5780" style="opacity:0" href="https://servers.fivem.net/servers/detail/e3oje3" class="button-2 w-button">Beitreten</a>
